/**
 * Retreived from https://github.com/dobots/crownstone-app/blob/master/www/js/ble.js
 *
 * Adapted for SLAC-DC
 *
The copyrights (2014) for this code belongs to DoBots and are provided under an noncontagious open-source license:
